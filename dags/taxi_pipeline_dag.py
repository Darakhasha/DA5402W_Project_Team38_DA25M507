...
with DAG(
    ...
    task_dvc_pull = BashOperator(
        ...
        bash_command='dvc pull data/raw/yellow_tripdata_2024-01.parquet.dvc || true',
        env=dvc_env,
    )
    ...
    task_clean_features = BashOperator(
        ...
        bash_command='python scripts/process_data.py --input data/raw/yellow_tripdata_2024-01.parquet --output data/processed/taxi_demand_features.parquet',
    )
